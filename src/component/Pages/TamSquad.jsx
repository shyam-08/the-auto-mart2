        ...
        <div style={{ fontfamily: 'Barlow, arial' }}>
          <div className='Section-thesquad  head-text'>
            ...
            <div >
              ...
              <img src="src\component\img\machine-nissan-gtr-nissan-wallpaper-thumb.jpg" style={{ height: '100%', width: '100%' }} />
          ...
          <div className="Section-6Squad">
            <div >
              ...
              <div className="row">
                <div className="col-md-6  col-sm-12">  <img src="src\component\img\skills-required-img-1.jpg" alt="communication image" className="Img-6Squad" /></div>
                <div className="col-md-6 col-sm-12" style={{paddingRight:'90px',paddingTop:"50px" }} >
              ...
              <div className="row">
                <div className="col-md-6 col-sm-12" style={{paddingLeft:'90px',paddingTop:"70px" }}><h2>PASSION FOR CARS</h2>
              ...
              <div className="row">
                ...
                <div className="col-md-6 col-sm-12"style={{paddingRight:'90px',paddingTop:"70px" }} ><h2>PRESENTATION SKILLS</h2>
              ...
              <div className="row">
                <div className="col-md-6 col-sm-12" style={{paddingLeft:'90px',paddingTop:"70px" }}>
