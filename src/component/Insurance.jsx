      ...
      <div>
        <div className="Insurance section-1 head-text ">
          <div >
            ...
            <img src="src\component\img\banner-img-1.jpg" alt="insurance-img" style={{
              height: '450px', width: '1330px', marginLeft: '0px'
            }} />
        ...
        <div className='Section-3Insurance'>
          <div className="container">
            ...
            <ul style={{ padding: "20px", display: "flex", listStyle: "none" }}>
        ...
        <div className="Section-4Insurance">
          <div className='container'>
            ...
            <h3>ADVANTAGE</h3>
            <div className="row">
              <div className='col-md-4 Vacate-Career' style={{ width: "32%", margin: "7px" }}>
